...
(1, '2023-11-30 02:12:16', 'Utility Company', 100, 'Electric bill', 1, 'john.doe@example.com'),
(2, '2024-02-04 02:12:16', 'Grocery Store', 200, 'Weekly groceries', 2, 'jane.smith@example.com'),
(3, '2023-07-09 02:12:16', 'Movie Theater', 50, 'Movie night', 3, 'alice.jones@example.com');

-- Inserting data into `goals`
INSERT INTO goals (email, name, amount, target_date, category_id, periodicity) VALUES
('john.doe@example.com', 'Save for Vacation', 2000, '2023-12-25', 1, 'Yearly'),
('jane.smith@example.com', 'New Car Fund', 10000, '2024-05-01', 2, 'Monthly'),
('alice.jones@example.com', 'Gaming PC', 1500, '2023-11-15', 3, 'One-time');
